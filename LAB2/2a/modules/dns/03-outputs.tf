# output "shinjuku_acm_validation_arn" {
#   value = aws_acm_certificate_validation.shinjuku_acm_validation01.certificate_arn
# }
...
# output "acm_certificate_arn" {
#   value = data.aws_acm_certificate.shinjuku_acm_cert01.arn
# }
...
# output "route53_record_fqdn" {
#   description = "FQDN of the Route53 ALB record"
#   value       = try(aws_route53_record.shinjuku_acm_validation.fqdn, "")
# }
...
#   value = data.aws_acm_certificate.shinjuku_acm_cert01.status == "ISSUED"
# }

# output "acm_certificate_validation_id" {
#   description = "ID of the ACM certificate validation resource"
#   value       = aws_acm_certificate_validation.shinjuku_acm_validation01.id
# }
...
output "shinjuku_cf_waf01_arn" {
  value = aws_wafv2_web_acl.shinjuku_cf_waf01[0].arn
}
